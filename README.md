...
python3 detect.py --weights runs/train/exp7/weights/last.pt --img 640 --conf 0.75 --source /media/alan/Linux/ProjetoCreathus/data-images/dataset_defeituosos.mp4

python3 val.py --weights runs/train/exp7/weights/last.pt --data custom_data.yaml --img 640 --iou 0.75 --half
